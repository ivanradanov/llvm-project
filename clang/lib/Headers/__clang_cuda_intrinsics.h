...
inline __device__ char __ldg(const char *ptr) { return *ptr; }
inline __device__ short __ldg(const short *ptr) { return *ptr; }
inline __device__ int __ldg(const int *ptr) { return *ptr; }
inline __device__ long __ldg(const long *ptr) { return *ptr; }
...
inline __device__ float __ldg(const float *ptr) { return *ptr; }
inline __device__ double __ldg(const double *ptr) { return *ptr; }
...
inline __device__ char2 __ldg(const char2 *ptr) {
  ...
  c2 rv = *(reinterpret_cast<const c2 *>(ptr));
  char2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ char4 __ldg(const char4 *ptr) {
  ...
  c4 rv = *(reinterpret_cast<const c4 *>(ptr));
  char4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ short2 __ldg(const short2 *ptr) {
  ...
  s2 rv = *(reinterpret_cast<const s2 *>(ptr));
  short2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ short4 __ldg(const short4 *ptr) {
  ...
  s4 rv = *(reinterpret_cast<const s4 *>(ptr));
  short4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ int2 __ldg(const int2 *ptr) {
  ...
  i2 rv = *(reinterpret_cast<const i2 *>(ptr));
  int2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ int4 __ldg(const int4 *ptr) {
  ...
  i4 rv = *(reinterpret_cast<const i4 *>(ptr));
  int4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ longlong2 __ldg(const longlong2 *ptr) {
  ...
  ll2 rv = *(reinterpret_cast<const ll2 *>(ptr));
  longlong2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ uchar2 __ldg(const uchar2 *ptr) {
  ...
  uc2 rv = *(reinterpret_cast<const uc2 *>(ptr));
  uchar2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ uchar4 __ldg(const uchar4 *ptr) {
  ...
  uc4 rv = *(reinterpret_cast<const uc4 *>(ptr));
  uchar4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ ushort2 __ldg(const ushort2 *ptr) {
  ...
  us2 rv = *(reinterpret_cast<const us2 *>(ptr));
  ushort2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ ushort4 __ldg(const ushort4 *ptr) {
  ...
  us4 rv = *(reinterpret_cast<const us4 *>(ptr));
  ushort4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ uint2 __ldg(const uint2 *ptr) {
  ...
  ui2 rv = *(reinterpret_cast<const ui2 *>(ptr));
  uint2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ uint4 __ldg(const uint4 *ptr) {
  ...
  ui4 rv = *(reinterpret_cast<const ui4 *>(ptr));
  uint4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ ulonglong2 __ldg(const ulonglong2 *ptr) {
  ...
  ull2 rv = *(reinterpret_cast<const ull2 *>(ptr));
  ulonglong2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ float2 __ldg(const float2 *ptr) {
  ...
  f2 rv = *(reinterpret_cast<const f2 *>(ptr));
  float2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
...
inline __device__ float4 __ldg(const float4 *ptr) {
  ...
  f4 rv = *(reinterpret_cast<const f4 *>(ptr));
  float4 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  ret.z = rv[2];
...
inline __device__ double2 __ldg(const double2 *ptr) {
  ...
  d2 rv = *(reinterpret_cast<const d2 *>(ptr));
  double2 ret;
  ret.x = rv[0];
  ret.y = rv[1];
  return ret;
