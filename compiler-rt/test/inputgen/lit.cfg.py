...
gen_args_full = 'rm %t.gen.exe.*.inp && ' + cxx_build_invocation(gen_args) + ' -c %s -o %t.gen.o && ' + cxx_build_invocation(gen_args_link) + ' %t.gen.o -o %t.gen.exe'
replay_gen_args_full = cxx_build_invocation(replay_gen_args) + ' -c %s -o %t.replay_gen.o && ' + cxx_build_invocation(replay_gen_args_link) + ' %t.replay.o -o %t.replay_gen.exe'
